![docker image](https://github.com/harrytyp/econversion-nomad/actions/workflows/docker-publish.yml/badge.svg)


# harrytyp's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of harrytyp.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    curl-L -o econversion-nomad.zip "https://github.com/harrytyp/econversion-nomad/archive/main.zip"
    unzip econversion-nomad.zip
    cd econversion-nomad
    ```
...
your `docker-compose.yaml` with `ghcr.io/harrytyp/econversion-nomad:main` for the services
...
and advanced configuration, see the [nomad-helm-charts](https://github.com/harrytyp/nomad-helm-charts) repository.
...
By default, no plugins are included in this distribution. You can find a list of available NOMAD plugins [here](https://nomad-lab.eu/prod/v1/oasis/gui/search/plugins). For a list of official plugins provided by FAIRmat, please see [here](https://github.com/harrytyp/.github/blob/main/profile/README.md). For inspiration, you can also check the list of [plugins that are installed on the production NOMAD deployment hosted by FAIRmat](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-distro/-/raw/main/pyproject.toml?ref_type=heads).
...
```sh
docker pull ghcr.io/harrytyp/econversion-nomad/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/harrytyp/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/harrytyp/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/harrytyp/econversion-nomad/manifests/main": unauthorized`
